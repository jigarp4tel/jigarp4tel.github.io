...
const ProjectCards = ({ project }) => {
    ...
    const { title, description, techList, liveURL, githubRepo } = project;
    ...
    return (
        <div className="project-cards">
            ...
            <div className="project-links">
                {liveURL && <a href={liveURL} className="live-link" target="_blank" rel="noreferrer">
